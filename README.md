...
Using Pandas and scikit-learn’s StandardScaler(), preprocess the dataset. This step prepares for Step 2, where you'll compile, train, and evaluate the neural network model.
...
Using TensorFlow, design a neural network, or deep learning model, to create a binary classification model that can predict if an Alphabet Soup-funded organization will be successful based on the features in the dataset. Determining the number of neurons and layers in your model. Then compile, train, and evaluate your binary classification model to calculate the model’s loss and accuracy.
